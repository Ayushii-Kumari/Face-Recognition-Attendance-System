...
cred = credentials.Certificate("C:\Users\KIIT0001\OneDrive\Desktop\Face Recognition\serviceAccountKey.json")
...
imgBackgorund = cv2.imread('resources/Background.png')

#Importing mode images into a list
folderModePath = 'C:\Users\KIIT0001\OneDrive\Desktop\Face Recognition\resources\Modes'
